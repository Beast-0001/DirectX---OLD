    ...
    const M = {
        embed: {
            ...
            fields: [{
                    ...
                    value: "- Put any numbers instead of 0 and 10.2 to multiply numbers. add a space between the numbers"
                },
                {
                    name: "`+add 2 2.8`",
                    value: "- Put any numbers instead of 2 and 2.8 to add numbers. add a space between the numbers"
                },
                {
                    name: "`+sub 10 2.4`",
                    value: "- Put any numbers instead of 10 and 2.4 to subtract numbers. add a space between the numbers"
                },
                {
                    name: "`+divide 8 4`",
                    value: "- Put any numbers instead of 8 and 4 to divide numbers. add a space between the numbers"
                },
                {
                ...
                {
                    name: "Issues?",
                    value: " [Report Them Here!](https://github.com/thebeastatelectricity/DirectX/issues) "
                }
            ],
            timestamp: new Date(),
            footer: {
